...
diagnoses:{
   columns: [
    ...
    { key: 'patient_name', label: 'Pet' },
    { key: 'description', label: 'Diagnosis' },  // Changed 'diagnosis' to 'description'
    { key: 'severity', label: 'Severity' },
    { key: 'actions', label: 'Actions' }
  ],
  fields: [
    { key: 'visit_id', label: 'Visit ID', type: 'number', required: true },
    { key: 'description', label: 'Diagnosis', type: 'text', required: true },  // Changed 'diagnosis' to 'description'
    { key: 'severity', label: 'Severity', type: 'text' }
  ],
